...
googletag.cmd.push(function() {
  ...
  build();
  googletag.defineSlot('/1479013/ocasas_cabezal', [[320, 50], [728, 90]], 'div-gpt-ad-1503513918839-0').defineSizeMapping(mapping).addService(googletag.pubads());
  var mapping = googletag.sizeMapping().
  addSize([0, 0], [320, 50]).
  addSize([780, 400], [320, 50]).
  addSize([1000, 400], [728, 90]).
  build();
  ...
  googletag.pubads().setTargeting('TipoPagina', ['Listado']);
